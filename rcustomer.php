...
<body>
    ...
    echo "<h1 style='color:black; margin-left:10%;margin-top:5%;'> Customer Report </h1>";
    ...
    if ($result = mysqli_query($conn, $sql)) {
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<input type='submit' name='searchbtn7' value='Search' style='float:right;margin-top:-10%;margin-right:23%;'>";
            echo "</form>";
            echo "<form action='include/customer.inc.php' method='POST'>";
            echo "<input type='submit' name='export' value='Export report to Excel' style='float:right;margin-top:-10%;margin-right:8%;'>";
