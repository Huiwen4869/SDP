...
<head>
    ...
    <?php cssAndBootstrap(); ?>
    <title>Category Report | Home Furniture</title>
</head>
...
<body>
    ...
    if ($result = mysqli_query($conn, $sql)) {
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<input type='submit' name='searchbtn1' value='Search' style='float:right;margin-top:-10%;margin-right:23%;'>";
            echo "<form action='include/category.inc.php' method='POST'>";
